...
1. Ensure your target Spotify playlist is set to **Public**.
2. Copy the full playlist link from your browser or Spotify app (e.g., `https://open.spotify.com/playlist/...`).
3. Run the script:
```bash
...
4. Paste the URL when prompted and press **Enter**.
